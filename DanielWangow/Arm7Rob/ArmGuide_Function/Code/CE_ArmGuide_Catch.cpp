...
{
{ 123, 60, 125, 90, 120, 90, 50 },{ 105, 65, 125, 90, 110, 90, 50 },
...
{ 110, 10, 93, 91, 150, 90, 50 },{ 100, 10, 93, 92, 150, 90, 50 },
{ 90, 23, 103, 91, 135, 90, 50 },{ 80, 10, 92, 90, 150, 90, 50 },
...
//抓取操作
void step_catch(double a[],double b[],int select_num)
{
    if(select_num==11||select_num==12)
    {
    Arm.move(angles_up);
    delay(2000);
    Arm.move(a);
    ...
    else if(select_num==14||select_num==15)
    {
    Arm.move(angles_up);
    delay(2000);
    Arm.move(a);
...
void step_select(int select_num)
{
    ...
    step_catch(ftransfer,ftransfer_catch,select_num); 
}
